...
com.dates <- read_csv("data/ceden_benthic_WQ.csv") # Erik's original datafram with only 64 observations
#com.dates <- read_csv("data/ceden_benthic_WQ_WBD.csv")
#names(com.dates)[names(com.dates)=="StationCode.x"] <- "StationCode"
```
