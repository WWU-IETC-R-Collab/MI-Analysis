...
HUC12<- st_crop(HUC12.WGS84, st_bbox(USFE.riskregions))

HUC12.WGS84 <- st_join(HUC12.WGS84, USFE.riskregions["Subregion"])

HUC12.WGS84 <- HUC12.WGS84 %>%
  filter(!is.na(Subregion))
```
...
com.dates.HUC <- com.dates %>%
  filter(HUC12.x == HUC12.y) #83 results
```
